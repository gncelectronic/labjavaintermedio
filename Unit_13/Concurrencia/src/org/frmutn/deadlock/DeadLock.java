 ...
 * 
 * Si la variable b es true el resource1 es bloqueado primero y luego se bloquea el resource 2
 * Si la variable b es false el resource2 es bloqueado pirmero por el hilo y luego el resource 1
 * 
 *   [thread-2] Recurso 2 bloqueado
 *   [thread-1] Recurso 1 bloqueado
 *   [thread-2] Intentando bloqueaer el recurso 1
 *   [thread-1] Intentando bloquear el recurso 2     -> DEAD LOCK
 * 
 * @author Gaston
 *
 */
